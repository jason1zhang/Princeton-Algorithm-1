...
/**
 * The data type to represent a set of points in the unit square 
...
public class KdTree {
    ...
    private Node insert(Node x, Point2D p, boolean vertical) {
        if (x == null) {
            ...
            // StdOut.println("the inserted point: " + p);
    ...
    public static void main(String[] args) {
        ...
        /*
         Point2D dupP = new Point2D(0.2, 0.3);
         kdtree.insert(dupP);
         StdOut.println("size: " + kdtree.size());   
         ...
         Point2D query = new Point2D(0.2, 0.3);
